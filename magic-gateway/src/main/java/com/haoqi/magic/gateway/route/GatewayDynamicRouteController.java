...
public class GatewayDynamicRouteController implements ApplicationEventPublisherAware {
     ...
     */
    @PostMapping("add")
    public Result<String> add(@RequestBody @Valid GatewayRouteDefinition gatewayRouteDefinition, BindingResult bindingResult) {
     ...
     */
    @PutMapping("update")
    public Result<String> update(@RequestBody @Valid GatewayRouteDefinition gatewayRouteDefinition, BindingResult bindingResult) {
        List<FieldError> fieldErrors = bindingResult.getFieldErrors();
        for (FieldError fieldError : fieldErrors) {
            return Result.buildErrorResult(fieldError.getDefaultMessage());
        }
