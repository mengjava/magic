 ...
 */
@Slf4j
public class CustomMobileLoginAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    private boolean postOnly = true;
    private final RedisTemplate<String, Object> redisTemplate;

    public CustomMobileLoginAuthenticationProcessingFilter(RedisTemplate<String, Object> redisTemplate, String defaultFilterProcessesUrl) {
        ...
        if (this.postOnly && !request.getMethod().equals(HttpMethod.POST.name())) {
            ...
            if (Objects.isNull(username)) {
                ...
                try {
                    ...
                    MobileAuthenticationToken authRequest = new MobileAuthenticationToken(username, context);
